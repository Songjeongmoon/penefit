			...
			<div class="centerinformation">
				<div class="centerinfo">
					...
					<div class="centerinfocenter">
						...
						<p class="desc">
							<strong style="font-weight: bold;">'반려인 문화교실 플랫폼’ Penefit은 대한민국에서 반려동물을 사랑하는 반려인들을 위한 환경을 만듭니다.</strong><br> 하나의 원데이클래스라는 틀을 넘어 반려동물과 반려인들을 위한 삶의 질을 향상 시킬 다양한 가능성을 제공하는 플랫폼입니다.
						</p>
					...
					<div class="centerinfobottom">
						...
						<div id="centerinfobottomright">
							...
							<p>반려동물 보유 가구가 대한민국 전체 가구의 3분의 1 수준에 달하며, 반려동물을 인생의 '반려자'로 여깁니다.</p>
							<p>Penefit은 사람과 반려동물이 행복하게 공존하는 사회를 목표로 동물복지와 반려문화 조성을 위해서 설립하게 되었습니다.</p>
						</div>
					</div>
				</div>
			</div>
