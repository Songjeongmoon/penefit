			...
			<div class="content">
				<ul class="qna">
					<li><input type="checkbox" id="qna-1"> <label
						for="qna-1">강아지동반 가능한가요?</label>
						<div>
							<p>네! 동반시 미리 연락주시고 마킹이 심한 친구들은 매너 밸트를 꼭 챙겨와주세요.</p>
						</div></li>
					<li><input type="checkbox" id="qna-2"> <label
						for="qna-2"> 결제방식은 어떻게 되나요?</label>
						<div>
							<p>앱과 PC에서 카드 / 무통장으로 결제 하실 수 있습니다.</p>
						</div></li>
					<li><input type="checkbox" id="qna-3"> <label
						for="qna-3">수업장소와 시간은 어떻게 되나요?</label>
						<div>
							<p>수업소개에 수업장소와 시간이 명시되어 있습니다. 자세히 명시 되어있지 않은 수업의 경우 튜터와 조율하여
								유동적으로 결정할 수 있습니다.
							<p>튜터에게 문의하여 시간을 조율해보세요. 개개인의 스케줄에 딱 맞는 시간을 조율할 수 있다는 것이 페네핏의
								가장 큰 장점이니까요.</p>
							
						</div></li>
					<li><input type="checkbox" id="qna-4"> <label
						for="qna-4">환불 절차는 어떻게 되나요?</label>
						<div>
							<p>“튜터에게 환불 의사 전달 > 환불 신청 > 담당자 확인 후 환불 접수(환불 신청 후 운영 시간 기준
								24시간 이내 완료) > 환불 진행 (무통장 재입금 / 카드 결제 취소 : 영업일 기준 5~7일 소요 > 환불
								완료” 의 절차로 진행됩니다.</p>
						</div></li>
					<li><input type="checkbox" id="qna-5"> <label
						for="qna-5">수업 중간에 사정이 생겨 그만 둘 경우에도 환불이 되나요?</label>
						<div>
							<p>첫 수업 이후 환불에 대해서는 회원가입 및 결제 시 수강생이 동의한 페네핏의 환불 규정에 따라 환불이
								진행됩니다. 자세한 사안은 환불규정을 참고해주세요.</p>
						</div></li>
				</ul>
			</div>
		</section>
