...
<body>
	...
	<div class="container">
		<table border="1">
			<tr>
				<th>번호</th>
				<td><input type="text" name="qna_num" value="${qna.qna_num }"
			...
			<tr>
				<td colspan="2"><c:if
						test="${sessionScope.member_id == qna.member_id }">
						<button type="button"
							onclick="location.href='qna_ModiView?qna_num=${qna.qna_num }'">수정</button>
						<button type="button"
							onclick="location.href='qna_delete?qna_num=${qna.qna_num }'">삭제</button>
					</c:if>
					<button type="button" onclick="location.href='QnA'">목록</button></td>
			</tr>
	...
	<div class="reply_container">
		<div class="reply_reg">
			<input type="text" name="qna_num" value="${qna.qna_num }"> <input
				type="hidden" name="reply_type" value="R"><br> <input
				type="text" name="member_id" value="${qna.member_id }"
